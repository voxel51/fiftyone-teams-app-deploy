...
func (s *secretsTemplateTest) TestData() {
	testCases := []struct {
		...
		},
		{
			...
			map[string]string{
				"secret.fiftyone.apiClientId":             "test-client-id",
				"secret.fiftyone.apiClientSecret":         "test-client-secret",
				"secret.fiftyone.auth0Domain":             "test-auth0-domain",
				"secret.fiftyone.clientId":                "test-client-id",
				"secret.fiftyone.clientSecret":            "test-client-secret",
				...
				"secret.fiftyone.organizationId":          "test-organization-id",
			},
			map[string]string{
				"apiClientId":             "test-client-id",
				"apiClientSecret":         "test-client-secret",
				"auth0Domain":             "test-auth0-domain",
