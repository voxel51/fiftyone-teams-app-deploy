...
func (s *commonServicesLegacyAuthDockerComposeTest) TestServiceImage() {
	testCases := []struct {
		...
		},
		{
			...
			[]string{legacyAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-api:v2.8.1",
		},
		{
			"defaultTeamsApp",
			"teams-app",
			[]string{legacyAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-app:v2.8.1",
		},
		{
			"defaultTeamsCas",
			"teams-cas",
			[]string{legacyAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cas:v2.8.1",
		},
		{
		...
		},
		{
			...
			[]string{legacyAuthComposeDelegatedOperationsFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cv-full:v2.8.1",
		},
	}
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{
				...
				"FIFTYONE_APP_TEAMS_SDK_RECOMMENDED_VERSION=2.8.1",
				"FIFTYONE_AUTH_SECRET=test-fiftyone-auth-secret",
