...
func (s *commonServicesInternalAuthDockerComposeTest) TestServiceImage() {
	testCases := []struct {
		...
		},
		{
			...
			[]string{internalAuthComposeFile, internalAuthComposeActivityFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-activity:v2.25.1",
		},
		{
			"defaultFiftyoneApp",
			"fiftyone-app",
		...
		},
		{
			...
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-api:v2.25.1",
		},
		{
			"defaultTeamsApp",
			"teams-app",
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-app:v2.25.1",
		},
		{
			"defaultTeamsCas",
			"teams-cas",
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cas:v2.25.1",
		},
		{
			...
			[]string{internalAuthComposeDedicatedPluginsFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-app-torch:v2.25.1",
		},
		{
			...
			[]string{internalAuthComposeFile, internalAuthComposeDelegatedOperationsFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cv-full:v2.25.1",
		},
		{
			"telemetryRedis",
			"telemetry-redis",
		...
		},
		{
			...
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/telemetry-sidecar:v2.25.1",
		},
		{
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{
				...
				"FIFTYONE_APP_TEAMS_SDK_RECOMMENDED_VERSION=2.25.1",
				"FIFTYONE_AUTH_SECRET=test-fiftyone-auth-secret",
