...
func (s *commonServicesInternalAuthDockerComposeTest) TestServiceImage() {
	testCases := []struct {
		...
		},
		{
			...
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-api:v2.23.0",
		},
		{
			"defaultTeamsApp",
			"teams-app",
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-app:v2.23.0",
		},
		{
			"defaultTeamsCas",
			"teams-cas",
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cas:v2.23.0",
		},
		{
			...
			[]string{internalAuthComposeDedicatedPluginsFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-app-torch:v2.23.0",
		},
		{
			...
			[]string{internalAuthComposeFile, internalAuthComposeDelegatedOperationsFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cv-full:v2.23.0",
		},
		{
			"telemetryRedis",
			"telemetry-redis",
		...
		},
		{
			...
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/telemetry-sidecar:v2.23.0",
		},
		{
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{
				...
				"FIFTYONE_APP_TEAMS_SDK_RECOMMENDED_VERSION=2.23.0",
				"FIFTYONE_AUTH_SECRET=test-fiftyone-auth-secret",
