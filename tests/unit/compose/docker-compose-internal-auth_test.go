...
func (s *commonServicesInternalAuthDockerComposeTest) TestServiceImage() {
	testCases := []struct {
		...
		},
		{
			...
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-api:v2.16.5",
		},
		{
			"defaultTeamsApp",
			"teams-app",
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-app:v2.16.5",
		},
		{
			"defaultTeamsCas",
			"teams-cas",
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cas:v2.16.5",
		},
		{
			...
			[]string{internalAuthComposeDedicatedPluginsFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-app-torch:v2.16.5",
		},
		{
			...
			[]string{internalAuthComposeDelegatedOperationsFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cv-full:v2.16.5",
		},
	}
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{
				...
				"FIFTYONE_APP_TEAMS_SDK_RECOMMENDED_VERSION=2.16.5",
				"FIFTYONE_AUTH_SECRET=test-fiftyone-auth-secret",
