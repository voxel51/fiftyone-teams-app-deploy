...
func (s *commonServicesInternalAuthDockerComposeTest) TestServiceImage() {
	testCases := []struct {
		...
		},
		{
			...
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-api:v2.6.2",
		},
		{
			"defaultTeamsApp",
			"teams-app",
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-app:v2.6.2",
		},
		{
			"defaultTeamsCas",
			"teams-cas",
			[]string{internalAuthComposeFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cas:v2.6.2",
		},
		{
		...
		},
		{
			...
			[]string{internalAuthComposeDelegatedOperationsFile},
			s.dotEnvFiles,
			"voxel51/fiftyone-teams-cv-full:v2.6.2",
		},
	}
	...
	testCases := []struct {
		...
		},
		{
			...
			[]string{
				...
				"FIFTYONE_APP_TEAMS_SDK_RECOMMENDED_VERSION=2.6.2",
				"FIFTYONE_AUTH_SECRET=test-fiftyone-auth-secret",
