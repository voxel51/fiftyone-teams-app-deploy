...
```yaml
teams-do-common:
  image: voxel51/fiftyone-app:v2.24.1
```
...
1. Upgrade all the datasets
    > **NOTE**: Any FiftyOne SDK less than 2.24.1
    > will lose connectivity at this point.
    > Upgrading to `fiftyone==2.24.1` is required.
...
> **NOTE**: Upgrading to FiftyOne Enterprise v2.24.1 *requires* your users to
...
1. [Upgrade to FiftyOne Enterprise v2.24.1](#upgrading-from-previous-versions)
   ...
   (this is not the default for this release).
    ...
    > Enterprise Database at this step until they upgrade to `fiftyone==2.24.1`
