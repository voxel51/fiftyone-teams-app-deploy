...
1. Upgrade all the datasets
    > **NOTE**: Any FiftyOne SDK less than 2.25.0
    > will lose connectivity at this point.
    > Upgrading to `fiftyone==2.25.0` is required.
...
> **NOTE**: Upgrading to FiftyOne Enterprise v2.25.0 *requires* your users to
...
1. [Upgrade to FiftyOne Enterprise v2.25.0](#upgrading-from-previous-versions)
   ...
   (this is not the default for this release).
    ...
    > Enterprise Database at this step until they upgrade to `fiftyone==2.25.0`
