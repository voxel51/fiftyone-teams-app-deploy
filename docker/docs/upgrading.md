...
1. [Upgrade to FiftyOne Enterprise version 2.16.5](#upgrading-from-previous-versions)
...
```yaml
teams-do-common:
  image: voxel51/fiftyone-app:v2.16.5
```
...
> **NOTE**: Upgrading to FiftyOne Enterprise v2.16.5 _requires_ a license file.
...
1. [Upgrade to FiftyOne Enterprise version 2.16.5](#upgrading-from-previous-versions)
1. Upgrade FiftyOne Enterprise SDK users to FiftyOne Enterprise version 2.16.5
    1. Login to the FiftyOne Enterprise UI
    1. To obtain the CLI command to install the FiftyOne SDK associated with
      your FiftyOne Enterprise version, navigate to `Account > Install FiftyOne`
1. Upgrade all the datasets
    > **NOTE**: Any FiftyOne SDK less than 2.16.5
    > will lose connectivity at this point.
    > Upgrading to `fiftyone==2.16.5` is required.
...
> **NOTE**: Upgrading to FiftyOne Enterprise v2.16.5 _requires_
...
> **NOTE**: Upgrading to FiftyOne Enterprise v2.16.5 _requires_ your users to
...
1. [Upgrade to FiftyOne Enterprise v2.16.5](#upgrading-from-previous-versions)
   ...
   (this is not the default for this release).
    ...
    > Enterprise Database at this step until they upgrade to `fiftyone==2.16.5`

1. Upgrade your FiftyOne SDKs to version 2.16.5
    1. Login to the FiftyOne Enterprise UI
