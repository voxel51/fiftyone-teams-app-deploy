...
```yaml
teams-do-common:
  image: voxel51/fiftyone-app:v2.7.2
```
...
1. Upgrade all the datasets
    > **NOTE**: Any FiftyOne SDK less than 2.7.2
    > will lose connectivity at this point.
    > Upgrading to `fiftyone==2.7.2` is required.
...
> **NOTE**: Upgrading to FiftyOne Enterprise v2.7.2 _requires_ your users to
...
1. [Upgrade to FiftyOne Enterprise v2.7.2](#upgrading-from-previous-versions)
   ...
   (this is not the default for this release).
    ...
    > Enterprise Database at this step until they upgrade to `fiftyone==2.7.2`
