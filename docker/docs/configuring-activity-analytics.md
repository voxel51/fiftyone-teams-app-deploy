...
(the dataset Activity tab and the sample history panel) alone.
...
| `VFF_WF_ACTIVITY`                     | `true`                             | Shows the dataset Activity tab and the sample history panel in `teams-app`.                                                          |
