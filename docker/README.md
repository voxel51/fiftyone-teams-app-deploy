...
| `FIFTYONE_APP_ANONYMOUS_ANALYTICS_ENABLED`            | Controls whether anonymous analytics are captures for the teams application. Set to false to opt-out of anonymous analytics.                                                                                                                                                                                                              | No                        |
