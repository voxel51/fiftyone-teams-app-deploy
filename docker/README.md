...
services:
  fiftyone-app:
    image: voxel51/fiftyone-app-torch:v2.24.0
```
...
| `FIFTYONE_APP_TEAMS_SDK_RECOMMENDED_VERSION` | The recommended fiftyone SDK version. This will be displayed in install modal (i.e. `pip install ... fiftyone==2.24.0`)                                                                                                                                                        | No                        |
