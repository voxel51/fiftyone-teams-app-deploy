...
| `FIFTYONE_APP_ENABLE_QUERY_PERFORMANCE`      | Controls whether Query Performance mode is enabled for the team application. Set to false to disable Query Performance mode for entire application.                                                                                                                            | No                        |
