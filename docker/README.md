...
Prior to v2.3.0, inviting users to join your FiftyOne Teams instance was not supported
when `FIFTYONE_AUTH_MODE` is set to `internal`.
Starting in v2.3.0+, you can enable invitations for your organization through the
...
1. [Upgrade to FiftyOne Teams v2.3.0](#deploying-fiftyone-teams)
