...
FiftyOne Enterprise v2.20.0 adds observability features viewable by
...
1. Upgrade all the datasets
    ...
    > **NOTE**: Any FiftyOne SDK less than 2.20.0 will lose connectivity after
    > this point.
    > Upgrading all SDKs to `fiftyone==2.20.0` is recommended before migrating
    > your database.
...
1. [Upgrade to FiftyOne Enterprise v2.20.0](#upgrading-from-previous-versions)
    ...
    > FiftyOne Enterprise Database until they upgrade to `fiftyone==2.20.0`
