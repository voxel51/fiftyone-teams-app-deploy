...
1. [Upgrade to FiftyOne Enterprise version 2.10.1](#upgrading-from-previous-versions)
...
In `v2.10.1`, the `values.yaml` location of startup probe settings
...
This has been removed in v2.10.1.
...
> **NOTE**: Upgrading to FiftyOne Enterprise v2.10.1 _requires_ a license file.
...
1. [Upgrade to FiftyOne Enterprise version 2.10.1](#upgrading-from-previous-versions)
1. Upgrade FiftyOne Enterprise SDK users to FiftyOne Enterprise version 2.10.1
    1. Login to the FiftyOne Enterprise UI
    1. To obtain the CLI command to install the FiftyOne SDK associated with
      your FiftyOne Enterprise version, navigate to `Account > Install FiftyOne`
...
1. Upgrade all the datasets
    ...
    > **NOTE**: Any FiftyOne SDK less than 2.10.1 will lose connectivity after
    > this point.
    > Upgrading all SDKs to `fiftyone==2.10.1` is recommended before migrating
    > your database.
...
> **NOTE**: Upgrading to FiftyOne Enterprise v2.10.1 _requires_
...
1. [Upgrade to FiftyOne Enterprise v2.10.1](#upgrading-from-previous-versions)
    > **NOTE**: At this step, FiftyOne SDK users will lose access to the
    > FiftyOne Enterprise Database until they upgrade to `fiftyone==2.10.1`
1. Upgrade your FiftyOne SDKs to version 2.10.1
    1. Login to the FiftyOne Enterprise UI
