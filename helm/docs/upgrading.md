...
1. To ensure that all datasets are now at version 1.11.1, run
...
1. Upgrade all the datasets
    ...
    > **NOTE**: Any FiftyOne SDK less than 2.14.1 will lose connectivity after
    > this point.
    > Upgrading all SDKs to `fiftyone==2.14.1` is recommended before migrating
    > your database.
...
1. [Upgrade to FiftyOne Enterprise v2.14.1](#upgrading-from-previous-versions)
    ...
    > FiftyOne Enterprise Database until they upgrade to `fiftyone==2.14.1`
