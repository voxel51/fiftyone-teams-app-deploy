...
Voxel51 assumes you are using the published Helm Chart to deploy your
FiftyOne Teams environment. If you are using a custom deployment
...
1. [Upgrade to FiftyOne Teams v1.7.0](#deploying-fiftyone-teams)
    > **NOTE:** At this step, FiftyOne SDK users will lose access to
        > the FiftyOne Teams Database until they upgrade to
        > `fiftyone==0.17.0`
