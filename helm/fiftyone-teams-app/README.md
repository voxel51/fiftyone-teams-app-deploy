...
|-----|------|---------|-------------|
| activitySettings | object | `{"enabled":true,"image":{"pullPolicy":"IfNotPresent","repository":"us-central1-docker.pkg.dev/computer-vision-team/dev-docker/fiftyone-activity","tag":"6ab5164b4bbcd5b277c6a640a9e7e1c3799dfeb6"},"mongo":{"database":""},"orgId":"","redis":{"enabled":true,"image":"redis:7","url":""},"resources":{"limits":{"cpu":"500m","memory":"512Mi"},"requests":{"cpu":"100m","memory":"128Mi"}},"snapshotIntervalMs":"","workers":{"ingest":{"command":["fiftyone-activity-ingest-worker"],"replicaCount":2},"rollup":{"command":["fiftyone-activity-rollup-worker"],"recreate":true,"replicaCount":1},"snapshot":{"command":["fiftyone-activity-snapshot-worker"],"recreate":true,"replicaCount":1}}}` | --------------------------------------------------------------------------- |
| activitySettings.enabled | bool | `true` | Master toggle for the Activity workers + Redis. |
