...
| delegatedOperatorJobTemplates.template.activeDeadlineSeconds | optional | `nil` | Maximum of seconds a job should be able to run. [Reference][affinity]. |
...
| delegatedOperatorJobTemplates.template.backoffLimit | optional | `nil` | Amount of retries for the job to try before being marked as "Failed". [Reference][affinity]. |
| delegatedOperatorJobTemplates.template.completions | optional | `nil` | Number of completions to run before marking the job as "Completed". [Reference][affinity]. |
...
| delegatedOperatorJobTemplates.template.ttlSecondsAfterFinished | optional | `nil` | Number of seconds for a job to sit idle before being automatically removed. [Reference][affinity]. |
