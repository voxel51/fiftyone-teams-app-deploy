...
| delegatedOperatorDeployments.deployments | object | `{}` | Additional deployments to configure. Each additional template ill use .Values.delegatedOperatorDeployments.template as a base. Each value present in the template is individually overridable. |
