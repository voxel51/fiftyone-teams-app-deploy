...
| secret.fiftyone.mongodbConnectionString | string | `""` | MongoDB Connection String. [Reference][mongodb-connection-string]. TLS is recommended when your MongoDB endpoint supports it (append `tls=true`; Atlas `mongodb+srv://` connections use TLS by default). |
