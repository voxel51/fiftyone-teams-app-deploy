...
| teamsAppSettings.env.VFF_Workflow_ACTIVITY | string | `"true"` | TEMPORARY dev flag: shows the workflow Activity tab (raw event tail, manager-only) for verifying event capture. Remove with the tab. |
