...
| teamsAppSettings.env.FIFTYONE_APP_ANONYMOUS_ANALYTICS_ENABLED | bool | `false` | Controls whether anonymous analytics are captures for the teams application. Set to true to opt-in to anonymous analytics. |
