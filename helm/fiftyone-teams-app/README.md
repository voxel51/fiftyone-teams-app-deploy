...
| secret.fiftyone.delegatedOperatorApiKey | string | `""` | An admin API key to use for running delegated operations, like a service account. <https://docs.voxel51.com/teams/api_connection.html#generating-an-api-key> This key is only required if `.Values.delegatedOperatorExecutorSettings.enabled`. |
